...
*/
  ...
  const redireccionarBusqueda = () => {
      props.history.push('/explorar');
  }
          ...
          <main role="main">
            <section className="text-center">
              <nav className="navbar navbar-expand-sm ml-5">
                ...
                <div
                  className="navbar-collapse collapse mt-2"
                  id="navbarsExample01"
                >
                  ...
                  <form
                    className="form-inline  my-md-0 "
                    onSubmit={props.mostrarDataFiltradaFunc}
                  >
                    <select
                      name="tipo_propiedad"
                      required
                    ...
                    >
                      ...
                      {tipoPropiedades.map(tipoPropiedad => (
                        <option
                          value={parseInt(tipoPropiedad.id)}
                    ...
                    <input
                      className="form-control form-control-xs input-area m-2"
                      name="areamt"
                      type="number"
                      placeholder="area"
                      onChange={recibirCambioInput}
                    ...
                    <input
                      className="form-control form-control-xs m-2"
                      name="titulo"
                      type="text"
                      placeholder="Buscar"
                      aria-label="Buscar"
                    ...
                    <button
                      type="submit"
                      onClick={redireccionarBusqueda}
                      className="ml-2 searchform_button search_button btn btn-primary btn-sm pt-2 pb-2 pl-4 pr-4"
                    >
                      Buscar
                    </button>
                  </form>
